...
class PasangBaru extends Page implements HasTable
{
    use InteractsWithTable;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';
    protected static ?string $navigationLabel = 'Pasang Baru';
    protected static ?string $title = '';
    protected static string $view = 'filament.admin-layanan.pages.pasang-baru';
    protected static ?string $slug = 'permohonan-layanan/pasang-baru';
        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('detail')
                    ->label('Lihat Detail')
                    ->icon('heroicon-o-eye')
                    ->url(fn (ServiceRequest $record): string => DetailPermohonan::getUrlForRecord($record, 'PASANG_BARU')),
                ...
                Action::make('kembalikan_pelanggan')
                    ->label(fn (ServiceRequest $record) => 'Kembalikan ke Pelanggan (Revisi ' . (($record->revision_count ?? 0) + 1) . '/2)')
                    ...
                    ->modalDescription(fn (ServiceRequest $record) =>
                        'Berikan catatan perbaikan untuk pelanggan. Revisi ke-' . (($record->revision_count ?? 0) + 1) . '/2')
