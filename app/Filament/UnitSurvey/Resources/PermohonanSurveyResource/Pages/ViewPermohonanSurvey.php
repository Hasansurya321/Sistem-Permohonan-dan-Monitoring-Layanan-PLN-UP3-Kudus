...
namespace App\Filament\UnitSurvey\Resources\PermohonanSurveyResource\Pages;

use App\Filament\UnitSurvey\Resources\PermohonanSurveyResource;
use Filament\Infolists\Infolist;
use Filament\Infolists\Components\Section;
use Filament\Infolists\Components\TextEntry;
use Filament\Resources\Pages\ViewRecord;

class ViewPermohonanSurvey extends ViewRecord
{
    protected static string $resource = PermohonanSurveyResource::class;
    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            Section::make('Data Permohonan')->schema([
                ...
                TextEntry::make('status_changed_at')->label('Tgl Update Status')->dateTime(),
            ])->columns(3),
            ...
            Section::make('Lokasi Instalasi')->schema([
                ...
                TextEntry::make('lokasi_provinsi')->label('Provinsi'),
