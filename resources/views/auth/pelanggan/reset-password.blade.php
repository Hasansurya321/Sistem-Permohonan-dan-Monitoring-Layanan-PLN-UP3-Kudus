...
<head>
    ...
    <title>Reset Password Pelanggan - PLN UP3 Kudus</title>
    ...
    <style>
        ...
        .bg-panel { max-width: 540px; margin: 0 auto; }
...
<body>
    <div class="bg-panel">
        <div class="card">
            <h1 class="text-3xl font-bold mb-3">Reset Password Pelanggan</h1>
            <p class="text-white/70 mb-6">Masukkan password baru untuk akun pelanggan Anda.</p>
            ...
            <form action="{{ route('pelanggan.reset-password') }}" method="POST" class="space-y-4">
                @csrf
            ...
            <p class="text-sm text-white/60 mt-4">Jika link sudah kadaluarsa, ajukan ulang permintaan reset password dari halaman login.</p>
        </div>
    </div>
</body>
</html>
